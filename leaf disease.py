...
app = Flask(__name__)
app.secret_key="leaf"
path1="C:\\leaf_prj\\leaf disease\\static\\images\\"
staticpath="C:\\leaf_prj\\leaf disease\\static\\"
fertilizerpath="C:\\leaf_prj\\leaf disease\\static\\fertilizer\\"
scanned_path = "C:\\leaf_prj\\leaf disease\\static\\scanned_img\\"
...
def add_agrioffice_add():
    ...
    image.save("C:\\leaf_prj\\leaf disease\\static\\officer\\"+image.filename)
    import random
...
def android_scanner():
    ...
    if photo is not None:
        ...
        #
            ...
            import  pandas as pd
        #
            balance_data = pd.read_csv(r'C:\\leaf_prj\\leaf disease\static\disdata.csv', sep=',', header=None)
        ...
        #
            ...
            db=Db()
            res=db.selectOne("SELECT * FROM `leaf` WHERE `name`='"+k[0]+"'")
            print(res)
            if res is not None:
                r['status']='1'
                r['name']=res['name']
